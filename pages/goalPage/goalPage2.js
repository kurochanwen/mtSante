...
export default class GoalPage2 extends Component<Props> {
  ...
  renderResult = () => (
    <>
      <ImageBackground
        ...
        source={require("../../assets/ver5/Bdesert.png")}
        resizeMode={"contain"}
      />
  ...
  renderGoals = () => (
    <>
      <ImageBackground
        style={styles.imageBackground}
        source={require("../../assets/backgrounds/4th-edition/desert.png")}
        resizeMode={"contain"}
      />
      {this.renderTopMenu()}
      <View
      ...
      >
        ...
        <Text style={{ color: "white", fontSize: 10 }}>05/06</Text>
      </View>
      <View
        style={{
          position: "absolute",
      ...
      >
        ...
        <Text style={{ color: "white", fontSize: 10 }}>05/08</Text>
      </View>
      <View
        style={{
          position: "absolute",
